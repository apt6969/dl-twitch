...
if __name__ == "__main__":
    ...
    parser.add_argument('--AUTO', action='store_true', help='--AUTO boolean for looping top streamers with getting metadata & screenshots but no videos')
    parser.add_argument('streamers', nargs=argparse.REMAINDER, help='command line arugments for specific streamer names')
    parser.add_argument('--NV', action='store_true', help='--NV boolean flag for videos to download')
    parser.add_argument('--TS', action='store_true', help='-TS boolean for getting top streamers and update all existing metadata')
    parser.add_argument('--NS', action='store_true', help='--NS boolean flag for no screenshots to download')
    ...
    TS_bool = args.TS
    NS_bool = args.NS
    USERS_bool = args.USERS
    STAFF_bool = args.STAFF
    AUTO_bool = args.AUTO
